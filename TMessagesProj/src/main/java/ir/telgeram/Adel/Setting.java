...
{
	private static final String PREF_NAME = ApplicationLoader.instance_number + "Stors";
	...
	{
		setupSetting();
		return pref.getInt("actionbarcolor", Color.parseColor("#0C867B"));
	}
	...
	{
		setupSetting();
		return pref.getInt("tabcolor", Color.parseColor("#0C867B"));
	}
