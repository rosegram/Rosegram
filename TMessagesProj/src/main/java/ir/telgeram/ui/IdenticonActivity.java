...
import ir.telgeram.messenger.EmojiData;
...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate
{
    ...
    public View createView(Context context) {
        ...
        codeTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        emojiTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
