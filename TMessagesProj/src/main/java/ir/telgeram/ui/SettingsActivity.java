...
import ir.telgeram.ui.Cells.TextInfoCell;
...
import ir.telgeram.ui.Cells.TextDetailSettingsCell;
...
import ir.telgeram.ui.Components.NumberPicker;
...
//        themeRow = rowCount++; // Adel Commented
    ...
    public View createView(Context context) {
        actionBar.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // Adel
        actionBar.setItemsBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor(), false); // Adel
        ...
        extraHeightView.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // Adel
        ...
        onlineTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
