...
import ir.telgeram.Adel.NewAdd.NoQuitContoller;
import ir.telgeram.Adel.NewAdd.hideChannelController;
...
//        topView.setBackgroundColor(AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id)); // Adel Commented
        ...
        for (int a = 0; a < 2; a++) {
            ...
            onlineTextView[a].setTypeface(AndroidUtilities.getTypeface(null)); // Adel
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            if (user_id != 0) {
                return i == phoneRow || i == settingsTimerRow || i == settingsKeyRow || i == settingsNotificationsRow ||
		                ...
		                i == startSecretChatRow || i == usernameRow || i == userInfoRow || i == groupsInCommonRow;
            } else if (chat_id != 0) {
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == emptyRowChat || i == emptyRowChat2) {
                ...
                return 2;
            } else if (i == leaveChannelRow || i == sharedMediaRow || i == fileMediaRow || i == audioMediaRow || i == urlMediaRow || i == musicMediaRow || i == settingsTimerRow || i == settingsNotificationsRow || i == startSecretChatRow || i == settingsKeyRow || i == membersRow || i == managementRow || i == blockedUsersRow || i == convertRow || i == addMemberRow || i == groupsInCommonRow) { // Adel
                return 3;
