...
import ir.telgeram.ui.Components.LineProgressView;
...
public class AudioPlayerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MediaController.FileDownloadProgressListener {
    ...
    public View createView(Context context) {
        ...
        timeTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        durationTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
