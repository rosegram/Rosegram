...
public class DialogCell extends BaseCell
{
	...
	public void setDialog(TLRPC.TL_dialog dialog, int i, int type, boolean hiddenmode)
	{
		...
		index = i;
		dialogsType = type;
		this.hiddenmode = hiddenmode; // Adel
		update(0);
	}
	...
	protected void onDraw(Canvas canvas)
	{
		...
		// Adel Start
		if (this.drawStatus && !drawNameBroadcast && !drawNameGroup && !drawNameBot)
		{
			int measuredWidth;
			if (LocaleController.isRTL)
			{
			...
			setDrawableBounds(this.statusBG, measuredWidth, AndroidUtilities.dp(46.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
