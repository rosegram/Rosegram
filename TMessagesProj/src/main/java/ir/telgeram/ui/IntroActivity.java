...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startMessagingButton.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
    ...
    private class IntroAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            headerTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
            messageTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
