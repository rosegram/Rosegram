...
import ir.telgeram.messenger.camera.CameraController;
import ir.telgeram.messenger.camera.CameraView;
...
import ir.telgeram.ui.Cells.PhotoAttachCameraCell;
import ir.telgeram.ui.Cells.PhotoAttachPhotoCell;
import ir.telgeram.ui.Cells.ShadowSectionCell;
import ir.telgeram.ui.ChatActivity;
import ir.telgeram.ui.PhotoViewer;
...
public class ChatAttachAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider, BottomSheet.BottomSheetDelegateInterface {
    ...
    public ChatAttachAlert(Context context, final ChatActivity parentFragment) {
        ...
        hintTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
