...
import ir.telgeram.messenger.DispatchQueue;
...
import ir.telgeram.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        infoTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        paramTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        valueTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        blurOffButton.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        blurRadialButton.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        blurLinearButton.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
