...
import ir.telgeram.ui.AudioPlayerActivity;
import ir.telgeram.ui.VoIPActivity;
...
public class FragmentContextView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateStyle(int style) {
        ...
        currentStyle = style;
        if (style == 0) {
            frameLayout.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // Adel
