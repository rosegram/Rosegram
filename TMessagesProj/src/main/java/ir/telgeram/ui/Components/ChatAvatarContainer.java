...
//                                subtitleTextView.setText(String.format("%s, %s",
//                                                                       info.participants_count + " " + LocaleController.getString("Member", R.string.Member) + (info.participants_count > 1 && LocaleController.getInstance().getCurrentLanguageName().equals("English") ? "s" : ""),
//                                                                       onlineCount + " " + LocaleController.getString("Online", R.string.Online))); // Adel
                            } else {
                                subtitleTextView.setText(LocaleController.formatPluralString("Members", info.participants_count));
//                                subtitleTextView.setText(info.participants_count + " " + LocaleController.getString("Member", R.string.Member) + (info.participants_count > 1 && LocaleController.getInstance().getCurrentLanguageName().equals("English") ? "s" : "")); // Adel
                            }
                        } else {
