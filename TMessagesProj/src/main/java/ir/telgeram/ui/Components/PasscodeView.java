...
import ir.telgeram.messenger.support.fingerprint.FingerprintManagerCompat;
...
public class PasscodeView extends FrameLayout {
    ...
    public PasscodeView(final Context context) {
        ...
        passcodeTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        passwordEditText.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
        ...
        if (Build.VERSION.SDK_INT >= 23 && parentActivity != null && UserConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    fingerprintTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
                    ...
                    fingerprintStatusTextView.setTypeface(AndroidUtilities.getTypeface(null)); // Adel
